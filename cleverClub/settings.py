"""
Django settings for cleverClub project.
...
'toolbar': [
            ...
            'link', 'unlink', '|', 'insertImage', 'imageUpload', 'imageTextAlternative', 'imageStyle:alignLeft', 'imageStyle:alignRight', 'imageStyle:alignCenter', 'imageStyle:side', '|',
            'insertTable', 'tableColumn', 'tableRow', 'mergeTableCells', 'tableProperties', 'tableCellProperties', '|',
            'codeBlock', 'sourceEditing', '|', 'mediaEmbed', '|',
            'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor', '|',
            'blockQuote', '|', 'copy', 'cut', 'paste', 'undo', 'redo', '|',
    ...
    'default': {
        'toolbar': {
            'items': [
                ...
                'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor', '|',
                'bulletedList', 'numberedList', 'todoList', '|', 'outdent', 'indent', 'alignment', '|',
                'link', 'unlink', '|', 'imageUpload', 'imageTextAlternative', 'imageStyle:alignLeft', 'imageStyle:alignRight', 'imageStyle:alignCenter', 'imageStyle:side', '|',
                'insertTable', 'mergeTableCells', 'tableProperties', 'tableCellProperties', '|',
                'codeBlock', 'sourceEditing', '|', 'mediaEmbed', '|',
